...
int main(void)
{
	...
	eMascota mascota6 = {1614,"Sebastian",'h',1};
	...
	printf("Quito el elemento del indice 1 de la lista\n");
	mostrarMascotas(lista);
	printf("\n");
	...
	printf("Determino el indice donde esta ubicado un elemento en la lista\n");
	...
	printf("Quito un elemento de la lista, del indice 4\n");
	mostrarMascotas(lista);
	printf("\n\n");

	ll_set(lista,0,puntero);
	printf("--**-- Uso de ll_set --**--\n");
	printf("Reemplaza el elemento que estaba en el indice 0 por el nuevo elemento\n");
	mostrarMascotas(lista);
	ll_clear(lista);
	isEmpty = ll_isEmpty(lista);
